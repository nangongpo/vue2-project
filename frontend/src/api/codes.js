...
export const REQUEST_MESSAGE = Object.freeze({
  ...
  [REQUEST_CODE.MFA_REQUIRED]: '需要继续验证',
  [REQUEST_CODE.MFA_INVALID]: '动态验证码无效或已使用',
  [REQUEST_CODE.MFA_ENROLL_REQUIRED]: '需要继续验证',
  [REQUEST_CODE.SECURITY_STEP_UP_REQUIRED]: '需要完成高风险操作验证',
  ...
  [REQUEST_CODE.SERVICE_UNAVAILABLE]: '服务暂时不可用',
})
